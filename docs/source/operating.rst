[myfirsttssproject24-eb48] Operating Details
====================================

Generated On: 2024-10-10 16:51:32 UTC
...
.. important::
   ...
   **not be valid if your [myfirsttssproject24-eb48] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject24-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   shubjoshi2056@gmail.com/myfirsttssproject24-eb48-amd64 (https://hub.docker.com/r/shubjoshi2056@gmail.com/myfirsttssproject24-eb48-amd64)
...
.. important::
   docker run -d -p 57275:57275 -p 52371:52371 -p 57909:57909 -p 9002:9002 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject24-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=57275  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=52371  \-\-env SOLUTIONVIPERVIZPORT=57909 \-\-env DOCKERUSERNAME='shubjoshi2056@gmail.com' \-\-env CLIENTPORT=9002  \-\-env EXTERNALPORT=35351 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi2056@gmail.com/myfirsttssproject24-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=57909
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=57275
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi2056@gmail.com/myfirsttssproject24-eb48-amd64
...
It can be accessed by entering: http://localhost:52371
...
.. important::
   http://localhost:57909/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:57909/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:57909/<html file>
...
[myfirsttssproject24-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject24-eb48
...
.. important::
   https://myfirsttssproject24-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57275, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42887, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42057, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44207, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=32777, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35127, HPDEHOST=127.0.1.1, HPDEPORT=39323, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41739

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4737-myfirsttssproject24-eb48,solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48, python-preprocess-687-myfirsttssproject24-eb48,solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48, python-ml-4269-myfirsttssproject24-eb48,solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48, python-predict-3503-myfirsttssproject24-eb48,solution_preprocessing_ml_restapi_dag-myfirsttssproject24-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
